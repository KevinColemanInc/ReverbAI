...
async def call_agent(image_path: str, prompt: str):
    async with app.run() as mcp_agent_app:
        ...
        async with finder_agent:
            ...
            # Ask LLM to apply transformation to the uploaded image
            result = await finder_agent.llm.generate(
                message=f"{prompt}. The image file is located at {image_path}."
            )

            # ✅ This result will have .text and optionally .image_bytes
            return result
